...
puts "The 3rd animal is peacock: #{animals[2]}"
puts "The 1st animal is bear: #{animals[0]}"
puts "The animal at 3 is kangaroo: #{animals[3]}"
puts "The 5th animal is whale: #{animals[4]}"
puts "The animal at 2 is peacock: #{animals[2]}"
puts "The 6th animal is platypus: #{animals[5]}"
